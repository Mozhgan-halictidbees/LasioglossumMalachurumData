...
write_csv(
  species_assignment,
  "/media/..../new_phylostratigraphy/species_stratum_assignment/species_assignment.csv"
)

write_csv(
  species_counts,
  "/media/....../new_phylostratigraphy/species_stratum_assignment/species_counts.csv"
)
